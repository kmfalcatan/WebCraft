                ...
                <table>
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) { 
                            ...
                            echo "<a href='../admin panel/approveAppointment.php?request_ID={$row['request_ID']}&id={$userID}'><img src='../assets/img/view.png' alt='View' class='action-img' style='width: 2.5rem; height: 1.rem;</a>";
