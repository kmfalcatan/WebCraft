...
$unitPrefix = 'UNIT';
$defaultUnitID = '0000';
$unit_ID = $unitPrefix . '-' . str_pad($unit_ID, strlen($defaultUnitID), '0', STR_PAD_LEFT); 
                ...
                <div class="otherInfoContainer">
                    <div class="subOtherInfoContainer" >
                        <div class="subInputInfoContainer2">
                            <textarea class="inputInfo3" name="unit_ID" cols="30" rows="10" placeholder="Unit ID:" readonly><?php echo $unit_ID; ?></textarea>
                        </div>
