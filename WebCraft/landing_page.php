    ...
    <div class="headerContainer">
        <div class="logoContainer">
            ...
            <div class="nameContainer">
               <img src="assets/img/system-name.png">
            </div>
        </div>

        <div class="buttonContainer">
            <div class="subButtonContainer">
                <button><a class="button1" href="about.php">About</a></button>
            </div>
            ...
            <div class="subButtonContainer">
                <button><a class="button3" href="authentication/login.php">Sign<span style="margin-left: 0.2rem;">in</span></a></button>
            </div>
        </div>
    </div>
